 ...
 * template to exist in every requested locale; unavailable localized templates
...
export class NotificationTemplateService {
   ...
   *
   * A requested locale may degrade to its base language first, then to the
   * configured English fallback.
   */
