...
describe("DigestService", () => {
  ...
  beforeEach(() => {
    groupBy = vi.fn().mockResolvedValue([
      { recipientUserId: "user:ada", channel: NotificationChannel.EMAIL },
    ]);
  ...
  describe("concurrency", () => {
    ...
    it("processes each recipient and channel group independently", async () => {
      groupBy.mockResolvedValue([
        { recipientUserId: "user:ada", channel: NotificationChannel.EMAIL },
        { recipientUserId: "user:ada", channel: NotificationChannel.TEAMS },
        { recipientUserId: "user:bob", channel: NotificationChannel.EMAIL },
      ]);
