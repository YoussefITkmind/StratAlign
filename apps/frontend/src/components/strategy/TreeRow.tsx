...
export default function TreeRow({ node, depth, lines, hasNextSibling, expandedIds, forceExpanded, onToggle, onAddChild }: Props) {
  ...
  return (
    <div>
      <div className="group flex items-stretch border-b border-gray-100 hover:bg-gray-50 md:h-[52px]">
        {/* connector columns */}
        {depth > 0 &&
        ...
        <div className="flex min-w-0 flex-1 flex-col gap-1.5 py-2.5 pr-3 sm:pr-4 md:flex-row md:items-center md:justify-between md:gap-4 md:py-0">
          ...
          <div className="flex items-center gap-3 sm:gap-4 md:shrink-0 md:gap-6">
