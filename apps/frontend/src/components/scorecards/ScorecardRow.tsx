  ...
  return (
    <div className="border-b border-gray-100 last:border-b-0">
      <div className="flex items-stretch">
        <button onClick={() => onToggle(scorecard.id)} className="flex min-w-0 flex-1 flex-col gap-2 px-4 py-3.5 text-left hover:bg-gray-50 md:flex-row md:items-center md:justify-between md:py-4">
        ...
        <Link
          ...
          data-testid={`open-scorecard-${scorecard.id}`}
          aria-label={`Open ${scorecard.name}`}
          title="Open master scorecard"
          className="flex shrink-0 items-center justify-center px-3 text-gray-300 hover:bg-gray-50 hover:text-blue-600"
        >
