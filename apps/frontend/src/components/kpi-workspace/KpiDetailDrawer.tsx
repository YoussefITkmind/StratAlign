...
const PERSPECTIVE_LABEL: Record<KpiDetailRow["perspective"], string> = {
  financial: "Financial",
  customer: "Customer",
  internal: "Internal",
  learning: "Learning",
...
const STATUS_META: Record<KpiDetailRow["status"], { label: string; bg: string; text: string; dot: string }> = {
...
export default function KpiDetailDrawer({ row, onClose }: { row: KpiDetailRow; onClose: () => void }) {
